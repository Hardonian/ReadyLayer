      ...
      <section className="py-16 lg:py-24 bg-surface-muted/50 border-t border-border-subtle">
        <Container size="lg">
          <motion.div
            ...
            viewport={{ once: true, margin: '-100px' }}
          >
            <h2 className="text-3xl font-bold mb-4">Ready to See Your Audit Trail?</h2>
            <p className="text-text-muted mb-6">
              Sign up for ReadyLayer to start reviewing AI-generated code with complete transparency and
              auditability.
            </p>
            <a
              href="/auth/signin"
